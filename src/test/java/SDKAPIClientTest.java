...
public class SDKAPIClientTest {
	...
	@Test
	public final void testCreateServiceObject() throws HttpError, URISyntaxException, ConnectException, ClientProtocolException {
		...
		ServiceObjectResponse response = sdkapi.createServiceObject(token, serviceObject);
